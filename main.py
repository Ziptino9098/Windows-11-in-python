...
myemail = input("Enter your email to send and recive emails:")
...
elif send_email_to == "noreply@outlook.com":
    print("That email is no reply you cannot email them")

elif send_email_to == "noreply@yahoo.com":
    print("That email is no reply you cannot email them")

elif send_email_to == "noreply@icloud.com":
    print("That email is no reply you cannot email them")

else:
    print("Email sent to "+send_email_to)
